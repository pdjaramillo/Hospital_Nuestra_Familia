                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-button text-center" class="d-inline">
                                    ...
                                    <form action="<?php echo e(route('eliminarpaciente', $paciente->id)); ?>" method="POST"
                                        class="d-inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Hospital_NF2\resources\views/paciente/paciente.blade.php ENDPATH**/ ?>