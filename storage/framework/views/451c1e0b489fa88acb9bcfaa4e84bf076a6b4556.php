        ...
        <div class="container"><a class="navbar-brand logo" href="#">Hospital Nuestra Familia</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('inicio')); ?>">Inicio</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('servicios')); ?>">Servicios</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('acceder')); ?>">Acceder</a></li>
...
</html><?php /**PATH C:\laragon\www\Hospital_NF2\resources\views/layouts/principal.blade.php ENDPATH**/ ?>