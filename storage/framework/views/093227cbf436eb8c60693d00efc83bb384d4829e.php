    ...
    <!------------------------------------------------------------Crear Cita--------------------------------------------------------->
    <div class="modal fade" id="citaModal<?php echo e($paciente->id); ?>" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nueva Cita para <?php echo e($paciente->name); ?>
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            data.medicos.forEach(function(row) {
                                s += '<option value="' + row.id + '">' + row.name + " " + row
                                    .apellido + '</option>'
                            })
...
<?php /**PATH C:\laragon\www\Hospital_NF2\resources\views/Modales/crearcita.blade.php ENDPATH**/ ?>