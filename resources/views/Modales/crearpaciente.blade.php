...
<div class="modal fade" id="crearPacienteModal{{ $clienterol->user_id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('paciente.crearpaciente', $clienterol->user_id) }}" method="POST">
