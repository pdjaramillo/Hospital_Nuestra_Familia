...
<div class="modal fade" id="diagnosticoModal{{ $historia }}" tabindex="-1" role="dialog" aria-labelledby="diagnosticoModal"
    aria-hidden="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="observaciones" class="form-control" name=""
                                    rows="5">{{ $historia->observaciones }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="diagnostico">Diagnostico</label>
                                <textarea id="diagnostico" class="form-control" name=""
                                    rows="5">{{ $historia->diagnostico }}</textarea>
                            </div>
                        </div>
                    </div>
            </div>
